...
,
  ...
  before8: { count: '05', type: 'GAME DESIGN & DEVELOPMENT', kicker: 'CASE STUDY / BEFORE 8AM', title: '在早八以前，离开这里。', lead: '《早八在逃》把熟悉的大学生活区翻转成午夜异常空间：玩家需要在有限时间内探索、搜刮、避开巡夜者，并决定何时带着战利品撤离。', meta: [['我的职责', '世界观 · 核心循环 · 系统设计 · Unity 开发'], ['核心机制', '潜行 · 搜刮 · 时间碎片 · 撤离抉择'], ['交付状态', 'TapTap 测试版已上线']], sections: [['01 / PREMISE', '凌晨 0 点以后，校园不再属于人类。玩家从宿舍翻窗进入，目标是在早八以前找到时间碎片，开启晨门并逃出去。'], ['02 / RUN LOOP', '翻窗 → 探索与搜刮 → 收集 3 个时间碎片 → 开启晨门 → 立即撤离或继续冒险。每一局都需要在安全与收益之间做选择。'], ['03 / STEALTH', '巡夜者通过距离、视角和遮挡判断玩家位置，发现后的追逐仍留有脱身空间；“绕墙躲开视线”是核心操作。'], ['04 / BUILD', '基于 Unity 2022.3 LTS 制作，使用 URP、Input System、AI Navigation 与 ScriptableObject 数据驱动，面向 PC 开发并考虑后续移动端体验。']], links: [['前往 TapTap 测试', 'https://tap.cn/lRKlLAoXX']] }
};
